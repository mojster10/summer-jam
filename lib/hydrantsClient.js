...
// Overpass API strežniki. Prvi (overpass-api.de) je ISTI privzeti
// strežnik, ki ga uporablja spletno orodje https://overpass-turbo.eu/,
// zato aplikacija vrne enake hidrante kot poizvedba na overpass-turbo.
// (overpass-turbo.eu je vmesnik za pisanje poizvedb, ne API; podatke
// vleče iz teh Overpass strežnikov.) Ostala dva sta rezerva.
const OVERPASS_ENDPOINTS = [
  "https://overpass-api.de/api/interpreter", // privzeti strežnik overpass-turbo.eu
